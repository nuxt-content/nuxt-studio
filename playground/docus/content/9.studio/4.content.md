...
- MDC syntax for [Markdown](/docs/files/markdown) files
...
It will eliminate the need to interact directly with complex file syntax. Instead, forms will be automatically generated based on your [collection schema](/docs/collections/define) definition.
