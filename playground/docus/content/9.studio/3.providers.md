...
```
  ...
  :::callout
  **Note**: Google OAuth is used for authentication only. You still need a GitHub Personal Access Token (`STUDIO_GITHUB_TOKEN`) to push changes to your repository.
  :::
::
