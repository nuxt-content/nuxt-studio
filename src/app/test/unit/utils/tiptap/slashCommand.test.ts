...
import { normalizeSlashCommandConfig } from '../../../../src/utils/slashCommand'
...
describe('normalizeSlashCommandConfig', () => {
  it('keeps supported exclude keys only', () => {
    expect(normalizeSlashCommandConfig({
      exclude: ['style', 'paragraph', 'nope'],
    })).toEqual({
      exclude: ['style', 'paragraph'],
    })
  })
})
