...
export type FormItem = {
  ...
  /** Overrides the default label (derived from the field key) when set in the collection schema `.editor({ label })`. */
  label?: string
  /** Shown as helper text for the field when set in `.editor({ description })`. */
  description?: string
