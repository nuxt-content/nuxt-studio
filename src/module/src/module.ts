...
export interface ModuleOptions {
  ...
  meta?: MetaOptions
  /**
   * Commit message configuration for content editor publishes.
   * When set, the prefix is prepended to user-entered messages for Commitizen/CI compatibility.
   */
  commitMessage?: {
    /**
...
export default defineNuxtModule<ModuleOptions>({
  ...
  async setup(options, nuxt) {
    ...
    nuxt.options.runtimeConfig.public.studio = {
      ...
      // @ts-expect-error Autogenerated type does not match with options
      commitMessage: options.commitMessage ?? { prefix: undefined },
    }
