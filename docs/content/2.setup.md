...
Restrict every Studio icon picker (collection forms and Vue component props in the visual editor) to a specific set of [Iconify](https://icones.js.org/) libraries using `meta.iconLibraries`. Values are Iconify collection prefixes.
