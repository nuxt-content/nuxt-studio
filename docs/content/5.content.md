  ...
  studio: {
    meta: {
      components: {
        ...
        // For components not matching any group, determine whether to include them in a fallback "Components" group or to omit them.
        ungrouped: 'include', // `include` (default) or `omit` will hide them
      }
    }
  }
})
