...
For self-hosted GitLab instances, provide your instance URL in both the auth and repository configuration:
...
See [Auth Providers](/auth-providers#self-hosted-gitlab) for OAuth application setup on your self-hosted instance.
