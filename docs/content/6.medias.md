...
For larger projects or teams with many media files, you can configure **external storage** to upload files directly to cloud storage. Studio uses [NuxtHub](https://hub.nuxt.com) blob storage as its storage layer, which supports Vercel Blob, AWS S3 and other S3-compatible providers.
